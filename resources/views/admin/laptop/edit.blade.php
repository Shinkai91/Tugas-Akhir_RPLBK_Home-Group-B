        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card" style="padding-bottom:20%;">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/admin/laptop/update">
                            @csrf
                            <div class="form-group row">
                                <label for="nama_laptop" class="col-md-4 col-form-label text-md-right">Nama</label>
                                <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="status">
                                        <option value="Finished" @if ($data->status === 'Finished') selected @endif>
                                            Finished</option>
                                        <option value="Ready" @if ($data->status === 'Ready') selected @endif>Ready
                                        </option>
                            ...
                            <div class="form-group row">
                                <label for="ID_Operator" class="col-md-4 col-form-label text-md-right">ID
                                    Operator</label>
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="id_operator"
                                        value="{{ $data->id_operator }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    ...
                                    <a class="btn btn-secondary" href="/admin/laptop">Cancel</a>
                                </div>
                            </div>
                        </form>
                    </div>
