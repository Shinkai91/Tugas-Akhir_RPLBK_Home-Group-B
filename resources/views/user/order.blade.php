                    ...
                    <div class="card-body">
                        <form method="POST" action="/user/order">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="city" class="form-control">
                                        ...
                                        <option value="Pudakpayung">Pudakpayung</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="laptop" name="laptop" onclick="calculate()"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input style="display:none" type="text" name="laptop" id="namalaptop"
                                        value="">
                            ...
                            <div class="form-group row">
                                <label for="totprice" class="col-md-4 col-form-label text-md-right">Total
                                    Price</label>

                                <div class="col-md-6">
                                    <input name="totprice" type="text" class="form-control" id="totprice"
                                        readonly>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="Date" class="col-md-4 col-form-label text-md-right">Pickup
                                    Date</label>
